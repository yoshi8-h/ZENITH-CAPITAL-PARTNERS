  ...
  <header class="header">
    <div class="header__inner">
      ...
      <nav class="header__nav">
        ...
        <div class="header__nav-item">
          <a href="<?php echo esc_url(get_post_type_archive_link('works')); ?>" class="header__link">実績紹介</a>
        </div>
        <div class="header__nav-item">
  ...
  <div class="drawer-menu js-drawer-menu">
    <div class="drawer-menu__wrap">
      <div class="drawer-menu__nav nav">
        ...
        <div class="nav__item">
          <a href="<?php echo esc_url(get_post_type_archive_link('works')); ?>" class="nav__link">実績紹介</a>
        </div>
        <div class="nav__item toggle">
          <button type="button" class="toggle__head js-accordion">
