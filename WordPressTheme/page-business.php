  ...
  <main class="main">
    ...
    <section class="solution-policy l-solution-policy">
      <div class="solution-policy__inner inner">
        <div class="solution-policy__title title02"></div>
        <p class="solution-policy__message"></p>
          ...
          <div class="solution-policy__content content3">
            ...
            <div class="content3__contents">
              <div class="content3__title">
                ...
                <div class="content3__title-text">理論と実践に基づいたソリューションを提供します。</div>
              </div>
          ...
          <div class="solution-policy__content content3">
            ...
            <div class="content3__contents">
              <div class="content3__title">
                ...
                <div class="content3__title-text">信頼関係を大切にします。</div>
              </div>
              <ul class="content3__list">
                <li class="content3__list-item list-item">地主・投資家・金融機関とは、成功事例を積み重ねることで信頼関係を、不動産をご利用されるユーザー様とは、快適な環境を提供することで信頼関係を構築します。</li>
